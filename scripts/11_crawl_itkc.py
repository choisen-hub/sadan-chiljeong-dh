...
(A) 퇴계 측  (권16~17 답기명언 계열 22편 전체)
    Source:    퇴계선생문집 권16-17 「答奇明彦」 series
    Container: 한국문집총간 ITKC_MO_0144A
    Note:      권16+권17 답기명언 letters는 총 22편(38,085자).
               분석 코퍼스는 22편 전체. 김세종(2024, 한국철학논집 83)이
               사단칠정 핵심으로 지목한 퇴계 발신 7편(1, 3, 5, 7, 9, 10, 12)은
               정성 검토의 참조 기준으로 활용.
               이 스크립트는 22편 전체를 추출한다.
...
DEFAULT_TARGETS = {
    "toegye_gobong_22pyeon": {
        ...
        "description": (
            ...
            "분석 코퍼스는 22편 전체 사용. "
            "핵심 7편 식별 기준: 김세종(2024), 한국철학논집 83."
        ),
    },
    "yulgok_ugye_9pyeon": {
        "munjip": "yulgok",
